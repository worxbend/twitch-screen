...
| RLY-41 | Added a resolved-runtime OSV audit to CI. Patched Netty and Jawn remove six advisory matches. Root scan covers 182 coordinates with two exact legacy exceptions expiring 2026-10-25; seven completeness/exception tests pass. [Dependency assessment](review-dependencies.md) records reachability, limits and required follow-up. OTel linkage is exercised by startup/tests; no claim of full vulnerability coverage. |
